...
export function helper(width=0.5, height=0.5, length=0.5, color=0xff0000) {
	//if(color == undefined) color = 0xff0000;//rgb(ri(0, 255), ri(0, 255), ri(0, 255));
	let material = mat('wire', color, false);
	return box(width, height, length, V0, V0, material, false);
}

export function box(width, height, length, position, rotation, material, shadow) {
...
export function sphere(radius, position, rotation, material, shadow, devisions) {
